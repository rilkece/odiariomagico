<!-- Chart code -->
<script id="script_diary_3" type='text/javascript'>
    var menuID = 3;
...
function createChart(type, dateIni, dateEnd, tag){
    ...
    for(var i = 1; i <= diffDays+1; i++){
        ...
        $.ajax({
            ...
            data: {'cargo': 'student', 'id': sessionStorage.getItem('id'), 'type': type, 'date': dataFormatada, 'tag': tag, 'interval': 'no'},
            dataType: "json",
            success: function (response) {
                ...
                if (linhas.length>0) {
                    ...
                    for (let i = 0; i < linhas.length; i++) {
                        ...
                        if (i==0) {
                            var line = {
                            "category": "apollo",
                            "date": element['date_ini'],
                            "event": element['name'],
                            "image": element['image'],
                            "rdate": element['date_ini']
                            };
                            dataChart.push(line);   
                            dateMin = element['date_ini'];
                        } else {
                            var line = {
                            "category": "apollo",
                            "date": element['date_ini'],
                ...
                if (catDay==diffDays+1) {
                    ...
                    var container = am4core.create("chartdiv_3", am4core.Container);
                    ...
                    dateAxis.min = new Date(dateMin).getTime();
                    dateAxis.max = new Date(dateMax).getTime();
                    ...
                    bullet.tooltipText = "{event}";
                    bullet.circle.radius = 4;
                    bullet.fill = altColor;
                    bullet.fillOpacity = 0.5;
                    bullet.strokeOpacity = 0;
                    //bullet.image.propertyFields.href = "image";
