...
$room_table = 'room_registers_'.$sala;
...
$sql = 'INSERT INTO '.$room_table.' (author, created, name, description, type, date_ini, date_end, image, room)
VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?);';
$stm = $conexao->prepare($sql);
...
$retorno = array('codigo' => 1, 'mensagem' => 'Registro da sala criado com sucesso.');
echo json_encode($retorno);
exit();
